...
public abstract class BinaryExpression implements Expression {
    ...
    public Expression getLeft() { return leftArgument; }

    public Expression getRight() { return rightArgument; }

    @Override
    public int depth() {
        return (leftArgument.depth() > rightArgument.depth()) ? leftArgument.depth() + 1 : rightArgument.depth() + 1;
    }
